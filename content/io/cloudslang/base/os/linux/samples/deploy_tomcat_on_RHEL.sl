...
####################################################
#!!
#! @description: Performs several linux commands in order to deploy Tomcat application on machines that are running RHEL based linux
...
#! @input source_path: absolute path of the folder containing scripts to be copied - Example: '/opt/apache-tomcat/bin'
...
#! @input script_file_name: the name of the script file - Usually startup.sh
  ...
  workflow:
    ...
    - verify_group_exist:
        ...
        navigate:
          ...
          - FAILURE: check_group_not_exist_result
